                    ...
                    <div class="row">
                                ...
                                <div class="container">
                                    <div class="avatar-upload">
                                        ...
                                        <div class="avatar-preview">
                                            <div id="imagePreview" style="background-image: url({{$GETDETAILS->COMPNAYLOGO}});">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12 margin_bottom_10">
                                    <div style="margin-top: 30px;">
                                        ...
                                        <div class="inputWithIcon">
                                            <input type="text" id="company_name" class="input_text margin_top_0 form-control" placeholder="Company Name" required="" data-parsley-trigger="blur"   value="{{$GETDETAILS->COMPANYNAME}}" data-parsley-required-message="Required">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 margin_bottom_10">
                                    <div style="margin-top: 30px;">
                                        ...
                                        <div class="inputWithIcon">
                                            <input type="text" id="admin_name" required="" data-parsley-trigger="blur" value="{{$GETDETAILS->ADMINNAME}} " data-parsley-required-message="Required" class="input_text margin_top_0 form-control" placeholder="Admin Name">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 margin_bottom_10">
                                    <div>
                                        ...
                                        <div class="inputWithIcon">
                                            <input type="text" id="empcode_format" class="input_text margin_top_0 form-control" placeholder="Employee Code" required="" data-parsley-trigger="blur" value="{{$GETDETAILS->EMPCODE}}" data-parsley-required-message="Required">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 margin_bottom_10">
                                    <div>
                                        ...
                                        <div class="inputWithIcon">
                                            <i class="feather icon-user inside_input_icon">      {{$GETDETAILS->CLIENTPREFIX}}</i>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_10">
                            <div>
                                ...
                                <div class="inputWithIcon">
                                    <input type="email" id="admin_emailid" class="input_text margin_top_0 form-control" placeholder="Email-ID" autocomplete="nope" required="" data-parsley-trigger="blur" onkeyup="checkemailId()" data-parsley-required-message="Required" value="{{$GETDETAILS->ADMINEMAILID}}">
                            ...
                            <div class="row">
                                <div class="col-md-8 col-sm-6 col-xs-12 margin_bottom_10">
                                    <div>
                                        ...
                                        <a href="#" style="font-size: 11px;" data-toggle="tooltip" data-placement="top" title="Must Contain 6 Charcter Atlest 1 Uper Case ,Lower Case, Number, and Special Charter @,#,_,-">Info</a>
                                        <div class="inputWithIcon">
                                            <input type="password" id="user_password" class="input_text margin_top_0 form-control" placeholder="Password" autocomplete="new-password" required="" data-parsley-trigger="blur" value="{{$GETDETAILS->PASSWORDS}}" data-parsley-required-message="Required" data-parsley-pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[a-zA-Z])(?=.*[@#_-]).{6,}">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_10">
                            <div>
                                ...
                                <div class="inputWithIcon">
                                    <input type="number" id="contatct_info"  value="{{$GETDETAILS->ADMINMOBILENO}}" class="input_text margin_top_0 form-control" placeholder="Contact Info" required="" data-parsley-trigger="blur" data-parsley-required-message="Required">
                                    <i class="feather icon-hash inside_input_icon"></i>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_10">
                            <div>
                                ...
                                <div class="inputWithIcon">
                                    <input type="number" id="user_lmit" value="{{$GETDETAILS->USERLIMITS}}" required="" data-parsley-trigger="blur" data-parsley-required-message="Required" class="input_text margin_top_0 form-control" placeholder="User Limit">
                                    <i class="feather icon-user inside_input_icon"></i>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_10">
                            <div>
                                ...
                                <div class="inputWithIcon">
                                    <input type="date" iname="startdate"value="{{date($GETDETAILS->AUTHENTICATION_START)}}"  id="startdate" required="" data-parsley-trigger="blur" data-parsley-required-message="Required" class="input_text margin_top_0 form-control" placeholder="Your name" value="{{date('Y-m-d')}}">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_10">
                            <div>
                                ...
                                <div class="inputWithIcon">
                                    <input type="number" id="no_of_days" value="{{$GETDETAILS->AUTHENTICATION_NUMBER}}"  onkeyup="getDate(this)" required="" data-parsley-trigger="blur" data-parsley-required-message="Required" class="input_text margin_top_0 form-control" placeholder="No. of Days / Month / Year">
                                    <i class="feather icon-hash inside_input_icon"></i>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_10">
                            <div>
                                ...
                                <div class="inputWithIcon">
                                    <input type="date" name="liciencedate" value="{{date($GETDETAILS->AUTHENTICATION_END)}}" id="liciencedate" required="" data-parsley-trigger="blur" data-parsley-required-message="Required" class="input_text margin_top_0 form-control" placeholder="End Date" >
                                    <i class="feather icon-calendar inside_input_icon"></i>
