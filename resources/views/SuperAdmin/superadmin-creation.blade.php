...
<div>
    <div class="h1_weight_700 shadow_patch">
        <div id="textbox" class="">
            <p class="alignleft bold_heavy bold_font_heading" id="add_client">Add Superadmins</p>
        ...
        <form action="#" id="client_form">
            <div id="form_patch">
                <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 margin_bottom_10">
                                <div style="margin-top: 30px;">
                                    ...
                                    <div class="inputWithIcon">
                                        <input type="text"  required=""   id="admin_name"  data-parsley-trigger="blur"
                    ...
                    <div>
                        <label for="name" class="label_patch">UID</label><a href="#"
                        style="font-size: 11px;" data-toggle="tooltip" data-placement="top"
                        title="Must Contain 14 Charcter Alfa Numreic "><i
                            class="feather icon-info inside_input_icon"
                            style="font-size: 15px;"></i></a>
                        <div class="inputWithIcon">
    ...
    var bg = $('#imagePreview').css('background-image');
        ...
        if (isValid) {
            ...
            if(vailidemail) {
                ...
                // return;
                $.ajax({
                    url: base_url  +  '/SuperAdmin/save-superadmins-creation',
                    type: 'POST',
                    data: {
                    ...
                    success: function(data) {
                        ...
                        if (response == 'EMAILPRESENT') {
                            ...
                            alert('Superadmin Created Succesfully');
                            window.history.back();
