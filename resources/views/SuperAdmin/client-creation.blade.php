                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_10">
                        <div class="row">
                            <div class="col-md-8 col-sm-6 col-xs-12 margin_bottom_10">
                                <div>
                                    <label for="name" class="label_patch">Password</label><a href="#" style="font-size: 11px;" data-toggle="tooltip" data-placement="top" title="Must Contain 6 Charcter Atlest 1 Uper Case ,Lower Case, Number, and Special Charter @,#,_,-"><i class="feather icon-info inside_input_icon" style="font-size: 15px;"></i></a>
                                    <div class="inputWithIcon">
