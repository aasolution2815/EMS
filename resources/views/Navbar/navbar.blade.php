                    ...
                    <div class="nav-list">
                        <div class="nav_patch-inner-navbar main-menu">
                            <div class="nav_patch-navigation-label">
                                ...
                                <li class="">
                                    <a href="{{url('/SuperAdmin/dashboard')}}" class="waves-effect waves-dark">
                            ...
                            <li class="nav_patch-hasmenu">
                                    ...
                                    <ul class="nav_patch-submenu">
                                        <li class="">
                                            <a href="{{url('/SuperAdmin/client-creation')}}" class="waves-effect waves-dark">
                                                <span class="nav_patch-mtext">
                                                    Add Client
                                                </span>
                                            </a>
                                        ...
                                        <li class="">
                                            <a href="{{url('/SuperAdmin/show-clients')}}" class="waves-effect waves-dark">
                                                <span class="nav_patch-mtext">
                                                    Show Client
                                                </span>
                                            </a>
                                        ...
                                        <li class="">
                                            <a href="{{url('/SuperAdmin/stop-clients')}}" class="waves-effect waves-dark">
                                                <span class="nav_patch-mtext">
                                                    Force Stop
                                                </span>
                                            </a>
                                        ...
                                        <li class="">
                                            <a href="{{url('/SuperAdmin/update-clients-license')}}" class="waves-effect waves-dark">
                                                <span class="nav_patch-mtext">
                                                    Update License
                                                </span>
                                            </a>
                            ...
                            <ul class="nav_patch-item nav_patch-left-item">
                                ...
                                <li class="">
                                    <a href="{{url('SuperAdmin/modules')}}" class="disabled waves-effect waves-dark">
                                        <span class="nav_patch-micon">
                                ...
                                <li class="">
                                    <a href="{{url('SuperAdmin/show-all-clients')}}" class="disabled waves-effect waves-dark">
                                        <span class="nav_patch-micon">
                                            <i class="feather icon-power"></i>
                                        </span>
